...
1. [How to use the AGDR Validator](#how-to-use-the-agdr-validator)
2. [AGDR Dictionary Specificities](#agdr-dictionary-specificities)
3. [How to read the outputs](#how-to-read-the-outputs)
4. [Creating an executable from the repo](#creating-an-executable-from-the-repo)
...
# AGDR Dictionary Specificities


- In the AGDR dictionary, a genome specimen_id or metagenome metagenomic_id can be connected to more than 1 experiment at a time.  
...
# Creating an executable from the repo

`cd src/agdrvalidator`

`pyinstaller --onefile --add-data=data/dictionaries/gen3.nesi_2025_01_24.json:agdrvalidator/data/dictionaries --name agdrvalidatorx_y __main__.py`

with *x.y* corresponding to the main version of the validator in the version file

`pyinstaller agdrvalidatorx_y.spec`

You will need to have your computer trusting the executable created.

e.g. for MacOS `xattr -dr com.apple.quarantine <binary_path_and_name>`
